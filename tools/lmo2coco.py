...
class_to_name_orig = {0: "fire_extinguisher"}

class_to_name = { 0: "fire_extinguisher"}

class_map = {                            #class map used for training
             0: 0
             }

def convert_lmo2coco(split='train', type='real', keyframes=None, datapath="./datasets/my"):   #####~
    if split == 'train':
    ...
    for data_folder_idx, data_folder in enumerate(data_folders):
        ...
        if data_folder_idx==0:
            ...
            obj_count = 0
            img_count = 0
        print(annotations_gt.keys())  # 打印所有键
...
if __name__ == "__main__":
    if args.split=='train':
        ...
        convert_lmo2coco(split='test', type='pbr',keyframes='bop', datapath=args.datapath)
    else:
