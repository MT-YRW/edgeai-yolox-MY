...
import cv2
_SUPPORTED_DATASETS = ["coco", "lm","lmo", "ycbv", "coco_kpts","my"]
_NUM_CLASSES = {"coco":80, "lm":15, "lmo":8, "ycbv": 21, "coco_kpts":1,"my":1}
_VAL_ANN = {
...
def main(kwargs=None, exp=None):
    ...
    if args.dataset is not None:
        ...
        if args.task is not None:
            ...
            if args.dataset == "lmo" or args.dataset == "my":   #####~ lm
    ...
    if args.export_det:
        if args.task == "object_pose":
            ...
            elif args.dataset == 'lmo' or args.dataset == "my":   #####~ lm
                camera_matrix = model.head.cad_models.camera_matrix
